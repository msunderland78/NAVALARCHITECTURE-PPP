...
class ApiTest(unittest.TestCase):
    ...
    def test_evaluate_route(self):
        ...
        self.assertAlmostEqual(payload["speeds"][0]["total_resistance_n"], 556830.6488552031)
    ...
    def test_csv_route(self):
        ...
        self.assertIn("556830.6488552031", payload)
    ...
    def test_json_export_route(self):
        ...
        self.assertAlmostEqual(payload["speeds"][0]["effective_power_kw"], 4296.872794794992)
