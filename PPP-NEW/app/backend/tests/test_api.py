...
class ApiTest(unittest.TestCase):
    ...
    def test_frontend_files_exist(self):
        ...
        self.assertIn("<title>Power Prediction Program (PPP)</title>", (FRONTEND / "index.html").read_text())
        self.assertIn("<h1>Power Prediction Program (PPP)</h1>", (FRONTEND / "index.html").read_text())
        self.assertNotIn("Performance Prediction Program", (FRONTEND / "index.html").read_text())
        ...
        self.assertIn("WATER_PRESETS", (FRONTEND / "pure.js").read_text())
        self.assertIn("fresh_water_15_c", (FRONTEND / "pure.js").read_text())
        self.assertIn("validateImportedCase", (FRONTEND / "pure.js").read_text())
