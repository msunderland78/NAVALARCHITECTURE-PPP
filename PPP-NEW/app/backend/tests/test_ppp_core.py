...
class PppCoreTest(unittest.TestCase):
    ...
    def test_sample_case_speed_terms(self):
        ...
        self.assertAlmostEqual(first["appendage_resistance_n"], 20636.80178805826)
        ...
        self.assertAlmostEqual(first["implemented_resistance_subtotal_n"], 530314.9036716219)
        self.assertAlmostEqual(first["design_margin_resistance_n"], 26515.745183581093)
        self.assertAlmostEqual(first["total_resistance_n"], 556830.6488552031)
        self.assertAlmostEqual(first["effective_power_kw"], 4296.872794794992)
    ...
    def test_appendage_equivalent_area_mode(self):
        ...
        self.assertAlmostEqual(first["implemented_resistance_subtotal_n"], first["frictional_resistance_n"] + first["rf_form_resistance_n"] + first["correlation_allowance_resistance_n"] + first["air_resistance_n"] + expected_appendage)
