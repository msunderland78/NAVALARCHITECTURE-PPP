...
class PppCoreTest(unittest.TestCase):
    ...
    def test_sample_case_speed_terms(self):
        ...
        self.assertAlmostEqual(first["residual_resistance_coefficient"], 0.0004408759633389348)
        self.assertAlmostEqual(first["appendage_resistance_n"], 23045.011942533478)
        self.assertAlmostEqual(first["wave_resistance_n"], 14145.908164522016)
        ...
        self.assertAlmostEqual(first["implemented_resistance_subtotal_n"], 580887.3169156016)
        self.assertAlmostEqual(first["design_margin_resistance_n"], 29044.365845780078)
        self.assertAlmostEqual(first["total_resistance_n"], 609931.6827613817)
        self.assertAlmostEqual(first["effective_power_kw"], 4706.635419097444)
        ...
        self.assertAlmostEqual(first["required_thrust_n"], 747585.0576842204)
