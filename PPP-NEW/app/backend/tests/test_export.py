...
class ExportTest(unittest.TestCase):
    def test_speeds_to_csv(self):
        ...
        self.assertEqual(lines[0], "speed_knots,speed_mps,froude_number,speed_length_ratio,reynolds_number,friction_coefficient,appendage_mode,appendage_equivalent_wetted_area_form_factor_m2,frictional_resistance_n,appendage_resistance_n,implemented_resistance_subtotal_n,design_margin_resistance_n,total_resistance_n,effective_power_kw,resistance_status")
