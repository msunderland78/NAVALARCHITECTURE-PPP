...
- The candidate `IN` field map now reaches the Fortran calculation path under Wine but still fails with a `DOMAIN error`; enum and candidate-field semantics remain unresolved.
